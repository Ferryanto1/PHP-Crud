...
if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($error)) {
    ...
    if ($registerPassword !== $confirmedPassword) {
        ...
        $sql = "INSERT INTO account (username, password, role) VALUES ('$registerUsername', '$hashedPassword', '$registerRole')";
...
<body>
    <div class="container">
        <form action="register.php" method="post">
            ...
            <input type="password" id="register_confirmed_password" name="register_confirmed_password" required>
